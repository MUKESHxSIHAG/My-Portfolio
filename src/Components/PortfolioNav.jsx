        ...
        <section className='bg-white'>
            <Container>
                <div className='d-flex justify-content-between py-1 align-items-center' >
                    <div>
                      <Link to="/"><img className='cursor-pointer' height={40}  src={Logo} alt="Logo" /></Link>
                    </div>
                    ...
                    <ul className={first ? 'd-flex justify-content-center align-items-center gap-5 nav_bar pt-2 ps-0' : "d-flex ps-0 gap-5 nav_bar pt-2 show"} >
                        ...
                        <li className='pt-2'><Link to="/about" className='fc-secondary fw-600 ff-openSans fs-20 hvr'>ABOUT</Link></li>
                        <li className='pt-2'><Link to="/tech " className='fc-secondary fw-600 ff-openSans fs-20 hvr'>TECH STACK</Link></li>
                        <li className='pt-2'><Link to='/projects' className='fc-secondary fw-600 ff-openSans fs-20 hvr'>PROJECTS</Link></li>
                        <li className='pt-2'><Link to='/contact' className='fc-secondary fw-600 ff-openSans fs-20 hvr'>CONTACT</Link></li>
